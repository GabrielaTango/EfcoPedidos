...
namespace Efco___Carga_de_pedidos.Negocio
{
    public class SQLH
    {
        public static string ToDateTime(DateTime dt)
        {
            ...
            if (dt.Year > 1)
            {
                ret = "CONVERT(DATETIME,'" + dt.ToString("yyyy-MM-dd") + "',102)";
            }

            return ret;
        }

        public static string ToInt(int entero)
        {
            string ret = "null";
        ...
        public static string ToLong(long nro)
        {
            string ret = "null";
        ...
        public static string ToDecimal(decimal dec)
        {
            string ret = "null";

            if (dec != -1)
            {
                ret = "" + dec.ToString("0.00").Replace(",", ".") + "";
            }
            return ret;
        }
        ...
        public static int CodeConverter(int position, string code)
        {
            int CodeConverter = 0;
        ...
        public static string DocNumberEncrypt(string pNumber)
        {
        ...
        internal static string ToSequence(string tabla)
        {
            return "NEXT VALUE FOR SEQUENCE_" + tabla;
        }

        private static string CharConverter(int iPosition, int iNumber)
        {
        ...
        public static string DocNumberDecrypt(string pNumber)
        {
        ...
        public static string CampoAdicional(string campo, string tipo, string tabla, bool llevaAs = true)
        {
            ...
            string ret = tabla + "CAMPOS_ADICIONALES.value('(/CAMPOS_ADICIONALES/" + campo + @")[1]', '" + tipo + @"') ";
        ...
        internal static string ToFloat(float flt)
        {
            string ret = "null";

            if (flt != -1)
            {
                ret = "" + flt.ToString("0.00").Replace(",", ".") + "";
            }
            return ret;
        }
    }
